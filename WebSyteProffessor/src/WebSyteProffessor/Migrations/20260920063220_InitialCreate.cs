        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceStoreName = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SiteSettingsId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProjectImageId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ImageUrl = table.Column<string>(type: "text", nullable: false),
                    ProjectId = table.Column<long>(type: "bigint", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductLinks_Videos_VideoId",
                        column: x => x.VideoId,
                        principalTable: "Videos",
                        principalColumn: "VideoId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WatchProgressId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WatchProgresses", x => x.WatchProgressId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_VideoId_UserId",
                table: "Favorites",
                columns: new[] { "VideoId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProductLinks_VideoId",
                table: "ProductLinks",
                column: "VideoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reactions_VideoId_UserId",
                table: "Reactions",
                columns: new[] { "VideoId", "UserId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WatchProgresses_VideoId_UserId",
                table: "WatchProgresses",
                columns: new[] { "VideoId", "UserId" },
                unique: true);
        }
