...
namespace WebSyteProffessor.Services
{
    public interface IVideoService 
    {
        ...
        Task<bool> UpdateAsync(long videoId, string title, string description, string youtubeUrl, long categoryId, bool isExclusive, long? projectId, List<(string StoreName, string ProductName, string Url)> productLinks);
